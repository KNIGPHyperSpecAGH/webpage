        ...
        <>
            <nav className="sticky top-0 z-10 bg-primary text-white">
                <div className="flex justify-between items-center p-4">
                    ...
                    >
                        <img
                            src={logo}
                            alt="Logo"
                            className="rounded-full bg-white p-0.5 h-14 w-14 -m-2 aspect-square"
                        />
                    </NavLink>
                    <div
                    ...
                    >
                        ...
                        ></span>
                        <span
                            className={`block w-8 h-1 bg-white rounded my-2 transition-all duration-300 ease-in-out ${
                                menuOpen ? "opacity-0" : ""
                            }`}
                        ></span>
                        <span
                ...
                >
                    <div
                        className={`
                            overflow-y-scroll overflow-x-hidden flex flex-col pb-12
                            navigation__shadow-scroll
                        `}
                    >
